    ...
    <form method="POST">
        <div class="row mb-3">
            <div class="col-6">
                ...
                <input type="text" class="form-control" name="ime" maxlength="25" required value="<?= htmlspecialchars($_POST['ime'] ?? '') ?>" placeholder="Marko">
            </div>
            <div class="col-6">
                <label class="form-label">Prezime <span class="text-danger">*</span></label>
                <input type="text" class="form-control" name="prezime" maxlength="25" required value="<?= htmlspecialchars($_POST['prezime'] ?? '') ?>" placeholder="Horvat">
            </div>
        </div>
        <div class="mb-3">
